...
const PlayerHelper = {
  ...
  setBaseData (skuId = "", filmDetail = {}, playInfo = {}) {
    this.skuId = skuId
    this.filmDetail = filmDetail
    this.playInfo = playInfo
    this.baseReportData = skuId ? { sku_id: skuId, film_name: filmDetail.filmName, ticket_no: playInfo.ticketNo } : null
  ...
  startMovie () {
    ...
    Player.start({
      src: this.playInfo.videoUrl,
      assetId: this.playInfo.kid,
      progress: this.playInfo.playProgress
    })
  },
